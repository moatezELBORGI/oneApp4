  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [
          if (!_isEditMode && !_isLoading && _apartment != null)
            IconButton(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    _apartment!.propertyName ?? 'Bien ${_apartment!.number}',
                  ...
                  Text(
                    'Appartement n°${_apartment!.number} - Étage ${_apartment!.floor}',
                    style: TextStyle(
                      fontSize: 16,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (_apartment!.buildingName != null)
              _buildInfoRow('Immeuble', _apartment!.buildingName!),
          ],
        ),
      ),
    );
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Mode édition activé pour les pièces',
                        style: TextStyle(
                          color: Colors.orange[800],
                          fontWeight: FontWeight.w500,
                        ),
    ...
    return Card(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          children: [
            if (_editingSection == 'customFields')
              Container(
                padding: const EdgeInsets.all(16),
                color: Colors.orange[50],
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Mode édition activé pour les champs spécifiques',
                        style: TextStyle(
                          color: Colors.orange[800],
                          fontWeight: FontWeight.w500,
                        ),
